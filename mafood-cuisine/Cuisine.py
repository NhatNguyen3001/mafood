  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #FFFFFF; border-bottom-style: solid;">
    ...
    <div class="collapse navbar-collapse " id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="http://mafood-location.herokuapp.com/" target="_blank" style="color: #000000;">Location</a>
        </li>
        <li class="nav-item">
...
if table:
    ...
    district_to_view = st.selectbox("", ("District 1", "District 2", "District 3", "District 4", "District 5", "District 6", "District 7", "District 8", "District 9", "District 10", "District 11", "District 12",
